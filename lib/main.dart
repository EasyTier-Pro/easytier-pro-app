      ...
      body: Column(
        children: [
          ...
          Expanded(
            child: SafeArea(
              top: false,
              child: _stage == AuthStage.authenticated
                  ? _WorkspaceHomeView(
                      session: session!,
...
class _UnauthenticatedBody extends StatelessWidget {
  ...
  final Future<void> Function(String url) onOpenBrowser;
          ...
          child: Center(
            child: ConstrainedBox(
              ...
              child: AnimatedSwitcher(
                ...
                child: switch (stage) {
                  AuthStage.checking ||
                  AuthStage.requestingCode => _LoadingView(
                    key: ValueKey<AuthStage>(stage),
                    message: statusMessage ?? '加载中...',
                  ),
